...
async def test_build_moe_text_queries_three_percentiles(monkeypatch):
    ...
    monkeypatch.setattr(moe_service, "find_tank_by_name", lambda _name: _tank())
...
async def test_build_moe_text_unknown_tank(monkeypatch):
    monkeypatch.setattr(moe_service, "find_tank_by_name", lambda _name: None)
...
async def test_build_moe_text_incomplete_data(monkeypatch):
    ...
    monkeypatch.setattr(moe_service, "find_tank_by_name", lambda _name: incomplete)
